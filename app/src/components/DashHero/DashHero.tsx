...
export const DashHero = ({ loading, modalState, quickText, setQuickText }: DashHeroOptions): ReactElement => {
    ...
    return <div className="bg-blue-600 text-white pt-20 pb-24 px-12">
        <div className="flex flex-col justify-center items-center">
            <input autoFocus={true} type="text" id="searchOrCreate" placeholder="Search or quickly create" value={quickText} onChange={e => { setQuickText(e.target.value); searchAPI() }} className={`appearance-none outline-none rounded-md w-full max-w-xl px-4 py-3 transition-all font-medium text-white bg-blue-800 placeholder-blue-500 hover:bg-blue-700 focus:bg-white focus:text-slate-900 ${loading ? "opacity-0" : "opacity-100"}`} />
            <div className="mt-16">
