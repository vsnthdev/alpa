...
export const CodeBlock = ({code}: {code: Code}): ReactElement => <div className="bg-white border-2 border-slate-200 w-full p-8 rounded-lg flex flex-col">
    ...
    {/* the link */}
    <div className={code.tags ? "mb-1" : "mb-5"}>
