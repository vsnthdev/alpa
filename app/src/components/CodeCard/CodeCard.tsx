...
export const CodeCard = ({code, modalState }: CodeCardOptions): ReactElement => {
    ...
    return <div className="bg-white border-2 border-slate-200 w-full p-8 rounded-lg flex flex-col">
        ...
        <div className="flex space-x-5 md:space-x-2">
            ...
            {/* edit button */}
            <Tippy content="Edit short code" theme="light" delay={700}><button className="outline-none transition-colors hover:text-primary" onClick={e => { openCodeModal(code, modalState) }}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 aspect-square" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* delete button */}
            <Tippy content="Delete this short code" theme="light" delay={700}><button className="outline-none transition-colors hover:text-primary" onClick={() => del({ apiHost, apiToken, dispatch, code: code.code })}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 aspect-square" fill="none" viewBox="0 0 24 24" stroke="currentColor">
