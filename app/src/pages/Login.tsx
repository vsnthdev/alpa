            ...
            <div className="bg-white p-8 flex flex-col rounded-xl border-2 border-slate-200 max-w-md">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col items-center space-y-2">
                        ...
                        <input className="w-full font-semibold px-3 py-2 border-2 outline-none border-slate-200 focus:border-blue-500 rounded-md" type="text" id="username" placeholder="alpa" autoFocus={Boolean(apiHost)} />
                    </div>
