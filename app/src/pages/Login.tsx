...
export default () => <main className="h-full flex justify-center items-center px-10">
        ...
        <div className="bg-white p-8 flex flex-col rounded-xl border-2 border-slate-200 max-w-md">
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-col items-center space-y-2">
                    <label className="mr-auto" for="username">Username</label>
                ...
                {/* password */}
                <div className="flex flex-col items-center space-y-2">
                    <label className="mr-auto" for="password">Password</label>
